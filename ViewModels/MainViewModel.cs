...
public class MainViewModel : ViewModelBase
{
    ...
    public MainViewModel()
    {
        ...
        Log.Insert(0, "Bienvenue dans la Guilde !");

        NextPhaseCommand = new RelayCommand(p =>
        {
        ...
        AssignDayCommand = new RelayCommand(p =>
        {
        ...
        AssignNightCommand = new RelayCommand(p =>
        {
        ...
        OpenResourcesCommand = new RelayCommand(p =>
        {
        ...
        OpenMerchantCommand = new RelayCommand(p =>
        {
    ...
    private void Seed(GuildState s)
    {
        ...
        s.Heros.Add(new Hero("Aventurier", cls));

        // Missions Jour 
        s.MissionsJour.Add(new Mission("Chasse en forêt", MissionType.Chasse, MissionPeriod.Jour, 2, 1, 8, 2));
        s.MissionsJour.Add(new Mission("Escorte caravane", MissionType.Escorte, MissionPeriod.Jour, 4, 2, 18, -4));
        s.MissionsJour.Add(new Mission("Petit donjon", MissionType.Donjon, MissionPeriod.Jour, 6, 2, 30, -2));
