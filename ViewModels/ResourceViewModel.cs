...
public class ResourceViewModel : ViewModelBase
{
    ...
    public ResourceViewModel(GuildState state, GameEngine engine, Action onChanged)
    {
        ...
        HealCommand = new RelayCommand(p =>
        {
        ...
        RestCommand = new RelayCommand(p =>
        {
            if (SelectedHero == null) return;
        ...
        DismissCommand = new RelayCommand(p =>
        {
            if (SelectedHero == null) return;
        ...
        EquipWeaponCommand = new RelayCommand(p =>
        {
            if (SelectedHero == null) return;
        ...
        EquipArmorCommand = new RelayCommand(p =>
        {
            if (SelectedHero == null) return;
